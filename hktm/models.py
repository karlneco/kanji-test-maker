...
class LessonMaterial(db.Model):
    ...
    date = db.Column(db.Text) # this will be the date - user wanted as a string so they can say 'week 3' if they wante
    content = db.Column(db.Text)
    bonus_available = db.Column(db.Integer)
    scoring_comment = db.Column(db.Text)
